...
@FeignClient("WasherFirstFeignClient", url = "\${biodiesel-washerFirst.url}")
interface WasherFirstClient {

    @PostMapping("/v1/supply", produces = [MediaType.APPLICATION_JSON_VALUE])
    fun performSupplyFirstWasher(@RequestBody decanterRequest: DecanterOutputRequest): DecanterOutputResponse
