package com.biodiesel.industry.biodiesel.second.washer.controller

import com.biodiesel.industry.biodiesel.second.washer.controller.converter.toResponse
...
import com.biodiesel.industry.biodiesel.second.washer.service.WasherSupplyService
...
class WasherSupplyController(
    ...
    fun performSupply(@RequestBody supplyRequest: SupplyRequest): SupplyResponse {
        logger.info("Starting process to perform second washer supply [$supplyRequest]...")

        return washerSupplyService.execute(supplyRequest).toResponse()
            .also {
                logger.info("Finished process to perform second washer supply. [$it]")
            }
    }
}