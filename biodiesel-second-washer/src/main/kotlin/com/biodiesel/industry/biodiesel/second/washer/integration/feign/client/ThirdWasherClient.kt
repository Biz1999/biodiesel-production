package com.biodiesel.industry.biodiesel.second.washer.integration.feign.client
...
@FeignClient("secondWasherFeignClient", url = "\${biodiesel-third-washer.url}")
interface ThirdWasherClient {
